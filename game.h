...
/**
 * @brief Test if there are three squares with the same color in a row in the
 *pointed direction
 * @param g the game
 * @param i row index
 * @param j column index
 * @param dir the direction to the targeted squares
 * @pre @p g must be a valid pointer toward a game structure.
 * @pre @p i < game height
 * @pre @p j < game width
 * @return true if there are three squares with the same color in a row, else
 *return false
 **/
